...
j.initSymbolIterator = function () {
  ...
  "function" != typeof Array.prototype[e] &&
    j.defineProperty(Array.prototype, e, {
      configurable: !0,
      writable: !0,
      value: function () {
...
j.polyfill = function (e, r, p, m) {
  if (r) {
    ...
    r != m &&
      null != r &&
      j.defineProperty(p, e, { configurable: !0, writable: !0, value: r });
  }
};
j.polyfill(
...
function setParticuleDirection(e) {
  var t = (anime.random(0, 360) * Math.PI) / 180, //泡泡的方向
    a = anime.random(40, 100), //泡泡的范围
...
function createParticule(e, t) {
  ...
  return (
    ...
    (a.radius = anime.random(8, 16)), //泡泡的大小
